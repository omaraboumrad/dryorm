    ...
    <div className="flex border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
      <button
        ...
        className={`flex-1 flex items-center justify-center gap-2 py-3 text-sm font-medium transition-colors
          ${state.showCode
            ? 'text-django-secondary border-b-2 border-django-secondary bg-white dark:bg-gray-900'
      ...
      >
        ...
        {state.rawQueries.length > 0 && (
          <span className="ml-1 px-1.5 py-0.5 text-xs rounded-full bg-django-secondary/20 text-django-secondary">
